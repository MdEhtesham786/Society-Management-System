...
const BillGeneration = (props) => {
  ...
  const amountInputHandlers = [
    ...
    {
      onChange: (e) => setIsCreditCheck(e.target.checked),
      value: isCreditCheck,
      label: "is Credit Limit?",
      type: "checkbox",
    },
    {
  ...
  const rebateInputHandlers = [
    ...
    {
      onChange: (e) => setRebateDays(e.target.value),
      value: rebateDays,
      label: "Rebate Days :",
      type: "number",
    },
  ...
  return (
    <>
      <div className="">
        ...
        <GenerateBills heading={"Rebate On null"} inputs={rebateInputs} />
        <GenerateBills heading={"Selection"} inputs={selectionInputs} />
