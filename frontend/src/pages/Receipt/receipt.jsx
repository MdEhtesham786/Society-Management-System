        ...
        <div className='bg-[#E9F2F2] h-[10%] my-2 rounded-lg flex flex-col px-6 py-3 border-[#cdcdcd] border drop-shadow-lg '>
            ...
            <div className="h-[60%] flex items-center">
                <div className='w-full flex justify-start'>
                    ...
                    <select id="countries" defaultValue={'bank'} className="w-[8.5rem] h-10  font-[500] bg-gray-50 border border-[#d5d5d5] text-[#282828]  rounded-lg focus:ring-blue-500 focus:border-blue-500 block  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    <option  value='bank' >Bank</option>
    <option value="cash">Cash</option>
  </select> 
  <select id="countries" defaultValue={'select_account'} className="mx-6 w-[12.5rem] h-10  font-[500] bg-gray-50 border border-[#d5d5d5] text-[#282828]  rounded-lg focus:ring-blue-500 focus:border-blue-500 block  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <option value="tdcc_bank">TDCC Bank</option> 
            ...
            {"View"}
                    ...
                    <div className="w-[50%] flex items-center text-lg font-[500]">
                        <p className='w-0 h-[1.8rem] max-h-[1.8rem] whitespace-nowrap overflow-hidden' style={{transition:"width .2s linear"}} ref={myRef}>Current Balance Amount : 720165.46</p>
                    </div>
        ...
        <div className='bg-[#E9F2F2] h-[30%] my-2 rounded-lg flex flex-col px-6  border-[#cdcdcd] border drop-shadow-lg '>
            ...
            <div className="h-[15%] flex items-center">
                ...
                <label htmlFor="entry_name" className=' text-lg grid place-items-center font-[500]'>Name :</label>
                <input type="text" name="entry_name" id="entry_name" className='w-[85%] h-10 rounded-lg border-[#d5d5d5] ml-2 border' />
                </div>
                <div className='w-[55%] flex justify-center'>
                <label htmlFor="entry_bank" className=' text-lg grid place-items-center font-[500]'>Bank :</label>
                <input type="text" name="entry_bank" id="entry_bank" className='w-[35%] h-10 rounded-lg border-[#d5d5d5] ml-2 border' />
                <label htmlFor="entry_branch" className=' text-lg grid place-items-center ml-4 font-[500]'>Branch :</label>
            ...
            <div className='flex w-[45%]'>
                ...
                <input type="number" name="principal" id="principal" className='w-[67%] h-10 rounded-lg border-[#d5d5d5] ml-2 border' />
                    ...
                    <div className="w-[50%] flex flex-col h-full ml-4">
                        ...
                        <p className="h-[50%] flex items-center text-lg font-[500]">Principal :</p>
            ...
            <div className="h-[28%] flex items-center   ">
                ...
                <label htmlFor="narration" className=' text-lg grid place-items-center font-[500]'>Narration :</label>
                    <textarea name="narration" id="narration" className="ml-2 resize-none w-[85%] h-24 rounded-lg border border-[#d5d5d5]"></textarea>
                </div>
          ...
          <CustomButton  onClick={handleCancelBtn}
            type={"submit"}
            style={{
        ...
        <div className='bg-[#E9F2F2] h-[20%] my-2 rounded-lg flex flex-col px-6  border-[#cdcdcd] border drop-shadow-lg '>
            ...
            <div className="h-[27%] flex items-center  ">
                <div className='flex w-[45%]'>
                <label htmlFor="selection_name" className=' text-lg grid place-items-center font-[500]'>Name :</label>
                <input type="text" name="selection_name" id="selection_name" className='w-[85%] h-10 rounded-lg border-[#d5d5d5] ml-2 border' />
                </div>
                <div className='w-[55%] flex justify-center'>
			...
			<Datepicker options={{...dateOptions,title:'To',inputIdProp:'end_date'}} onChange={handleChangeTwo}  show={showTwo} setShow={handleCloseTwo} classNames="w-[35%]" />
                ...
                <select id="records" name="records" defaultValue={'10'} className="ml-4 w-[7.5rem] h-10  font-[500] bg-gray-50 border border-[#d5d5d5] text-[#282828]  rounded-lg focus:ring-blue-500 focus:border-blue-500 block  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <option value="50">50</option> 
            ...
            <CustomButton  onClick={handleSearchBtn}
            type={"submit"}
            style={{
                backgroundColor: "#119F8E",
                boxShadow: "2px 4px 4px 0px #00000040",
    ...
    <p className="w-[11%] border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg  ">Sr. No.</p>
    <p className="w-[9%]  border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg ">Doc. No.</p>
    <p className="w-[13%]  border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg ">Date</p>
    <p className="w-[19%]  border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg ">Name</p>
    <p className="w-[12%]  border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg ">Amount</p>
    <p className="w-[9%]  border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg ">Cheque No.</p>
    <p className="w-[9%]  border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg ">Bank</p>
    <p className="w-[9%]  border border-t-[0px] border-[#9F9F9F] border-l-[0px] border-b-[0px] border-r-[1px] grid place-items-center font-semibold text-lg ">Edit</p>
    <p className="w-[9%] grid place-items-center font-semibold text-lg  ">Delete</p>
</div>
                {arr.map((e,i)=>{
                    return(
                        <div className={`min-h-12 statement ${i%2===0?'bg-transparent':'bg-[#F3F9FB]'} ${arr.length-1===i&&arr.length>7?'border-b-[0px]':'border-b[1px]'} border border-t-[0px] border-l-[0px] border-r-[0px] border-[#9F9F9F]  flex`} key={i}>
