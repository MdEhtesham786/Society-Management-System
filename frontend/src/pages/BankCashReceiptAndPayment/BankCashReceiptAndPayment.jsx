    ...
    <>
      <div className="flex flex-col bg-blue h-[85rem] px-2">
        ...
        <div className="bg-[#E9F2F2] h-[10%] my-2 rounded-lg flex flex-col px-6 py-3 border-[#cdcdcd] border drop-shadow-lg ">
          <div className="flex justify-between items-center h-[40%] underline underline-offset-4 font-semibold">
            ...
            <div className="w-full flex justify-start">
              <div className="w-[35%] flex">
                <select
                  ...
                  className="mr-6 w-[12.5rem] h-10  font-[500] bg-gray-50 border border-[#d5d5d5] text-[#282828]  rounded-lg focus:ring-blue-500 focus:border-blue-500 block  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                >
